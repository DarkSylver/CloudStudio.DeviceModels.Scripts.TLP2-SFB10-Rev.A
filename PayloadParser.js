function parseUplink(device, payload) {
    ...
    if (decodedMessage.bleDataList != null && Array.isArray(decodedMessage.bleDataList)) {
        for (var i = 0; i < decodedMessage.bleDataList.length; i++) {
            ...
            if (ble && ble.mac === "c545c43dc568" && ble.temp != null) {
            ...
            if (ble && ble.mac === "c545c43dc568" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "c545c43dc568" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "c545c43dc568" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "c545c43dc568" && ble.rssi != null) {
            ...
            if (ble && ble.mac === "f5f7bc7578ef" && ble.temp != null) {
            ...
            if (ble && ble.mac === "f5f7bc7578ef" && ble.humidity != null) {
            ...
            if (ble && ble.mac === "f5f7bc7578ef" && ble.lightIntensity != null) {
            ...
            if (ble && ble.mac === "f5f7bc7578ef" && ble.batteryPercent != null) {
            ...
            if (ble && ble.mac === "f5f7bc7578ef" && ble.rssi != null) {
